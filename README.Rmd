...
`{manypkgs}` is a package from the [qData](https://github.com/globalgov/qData) ecosystem. 
...
The `qData::get_packages()` function can be used to discover the packages from our ecosystem currently available.
