...
the qID under this format: "RUS-USA[17]_1971P[FI]:RUS-USA[17]_1967A[FI]". 
It is composed of the parties (RUS-USA), the number of words that are contained in the treaty
title (17), the date of signature of the protocol (1971), the type (P) which refers to Protocol.
The action [FI] which stands for "fishing" is only added in the qID when other treaties from the same 
parties signed other treaties on the same year. It allows to differentiate them. Finally, the linkage 
...
This represents the acronym (SFDP), the signature year of the amendment (20070817), the type (E),
...
Amendment of known treaties | J09H_1990E2:MARPOL1973A | acronym_uID,type(number):linkage,type

Famous multilateral treaties have a simplified qID with a known abbreviation. 
For example, the United Nations Convention On The Law Of The Sea will have the following qID: "UNCLOC1982". 
This is the known abbreviation (UNCLOS) and the signature year (1982). 
The protocols or amendments of the known treaties will have this qID format: "1989E2_MARPOL1973A". 
It indicates the acronym (J09H), the signature date of this specific amendment (19900316), the type of treaty (E),
its number (2) and the qID of the "mother" treaty (MARPOL19731102) followed by the type (A).
...
Each treaty contains a unique number in their qID which refer to the signature date (called 
"uID"). 
