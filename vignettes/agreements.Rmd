...
agreements$qID <- qCreate::code_agreements(agreements$titles, agreements$dates)
...
A bilateral treaty that is an agreement will have the following qID: "19060521_MEX-USA". 
This is a combination of the date (19060521) with the parties to agreement (MEX-USA). 
A bilateral treaty that is any other type than an agreement (e.g. protocol, amendments) will have 
the qID under this format: "18840921E3_18830703_BAD-CHE ". 
The date of signature of the amendment (18840921), the type (E) which refers 
...
A multilateral treaty that is an agreement will have the following qID: "20050205A" which 
indicates the signature date of the agreement (20050205) and the type (A). 
A multilateral treaty that is not an agreement will have this qID format: "19920817E2_20070817". 
This represents the signature date of the amendment (20070817), the type (E), the number of amendment (2) and
the linkage number (19920817A) which is the qID of the "mother" treaty. 
...
It indicates the signature date of this specific amendment (19900316), the type of treaty (E), its number (2) and 
the abbreviation and signature date of the "mother" treaty (MARPOL19731102).
...
In that case, the ID will also contain the action extracted from agreement titles.
Actions are abbreviations for the function of agreement (usually verbs present in title).
