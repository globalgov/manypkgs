...
agreements$fuzzy <- ifelse(is.na(agreements$fuzzy), "0", 1)

agreements <- agreements %>% 
  dplyr::mutate(fuzzy = ifelse(strict == 1, 1, fuzzy))
agreements$fuzzy <- as.numeric(agreements$fuzzy)
