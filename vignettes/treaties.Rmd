...
Please see check the [Agreements](https://globalgov.github.io/manypkgs/articles/agreements.html) vignette for more information on how `code_agreements()` works
and its' performance vis-a-vis other matching options.
Notice that titles in 'many' datasets were first standardised using `standardise_titles()`.
