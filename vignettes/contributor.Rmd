...
three-dimensional datacubes that resembles a data cube (a list object where entries are tibbles).
...
connected into a datacube. `{manydata}` contains several functions geared towards data wrangling. 
...
Datasets part of the same datacube should have similar variables
...
the datacube name as a string. 
Corrected datasets can be connected to form a three dimensional datacube
that resembles a data cube.
The website source of the data should be indicated in the third argument of the function.
The function creates a datacube in a data folder to store corrected datasets,
