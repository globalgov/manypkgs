...
We’ve made it easier than ever to install and start analysing global governance data in R. Simply install the core package, [manydata](https://github.com/globalgov/manydata), as follows, and you can discover, install, and update various packages from the many packages universe.
...
As such, we make it easy to cite both the particular datasets you use by listing the
...
please reach out by flagging this as an
...
If you have any other ideas about how this package, or the avrious 'many packages',
