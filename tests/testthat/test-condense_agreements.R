...
data8 <- data.frame(treatyID = c("MEX-TEX[FQG]_1944P",
                    ...
                    manyID = c("MEX-TEX[FQG]_1944P:MEX-TEX[FQG]_1944A",
                               "MEX-TEX[FQG]_1944A",
                               "MEX-TEX[FQG]_1944P:MEX-TEX[FQG]_1944A"))
data9 <- data.frame(treatyID = c("MEX-TEX[FQG]_1944P",
                                 "MEX-TEX[FQG]_1944A"),
                    manyID = c("MEX-TEX[FQG]_1944P:MEX-TEX[FQG]_1944A",
                               "MEX-TEX[FQG]_1944A"))
data10 <- data.frame(treatyID = c("MEX-TEX[FQG]_1944P",
                                  "MEX-TEX[FQG]_1944A"),
                     manyID = c("MEX-TEX[FQG]_1944P",
                                "MEX-TEX[FQG]_1944A"))
...
test_that("linkage generated from agreements in same dataset", {
  # scenario 1: manyID generated with linkage when one of the datasets in the database contains both agreements so that treatyID in one dataset is generated with linkage
  ...
  # expect_equal(data9$manyID, d$manyID)
  expect_equal(data10$manyID, d$manyID)
  # scenario 2: treatyID not generated with linkage due to different titles, but linkage is generated in manyID due to similar treatyIDs
